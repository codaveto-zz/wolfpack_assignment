...
class HijackedExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const HijackedExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
  ...
  @override
  _HijackedExpansionTileState createState() => _HijackedExpansionTileState();
}

class _HijackedExpansionTileState extends State<HijackedExpansionTile> with SingleTickerProviderStateMixin {
